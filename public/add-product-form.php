                   ...
                   // $packate_measurement = $db->escapeString($fn->xss_clean($_POST['packate_measurement']));
                     $product_id = $db->escapeString($res_inner[0]['id']);
                      ...
                      //  $stock_unit_id = $db->escapeString($fn->xss_clean($_POST['packate_stock_unit_id'][$i]));
                        ...
                        $sql = "INSERT INTO product_variant (product_id,price,discounted_price,stock,serve_for) VALUES('$product_id','$price','$discounted_price','$stock','$serve_for')";
                        $db->sql($sql);
                    ...
                    <div class="box-body">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                        <label for="stock">Stock:</label>
                                            <input type="number" step="any" min="1" class="form-control" name="packate_stock" required>
                                     </div>
                                </div> 
                      ...
                      <!--   <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <input type="hidden" name="product_pincodes" id="product_pincodes" class="form-control" value="all" required>
                        <div class="row">
                           <!--  <div class="col-md-4">
                                <div class="form-group">
