...
define('DOMAIN_URL', '/Sriranganathageneralstore-App/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_pass = "";
    private $db_name = "sriranganathageneralstore_app";    // Change as required
